        ...
        if flag==1:
            ...
            if books[0]>0:
                ...
                try:
                    ...
                    mydb.commit()
                    print("deleted 1 row from issued_book")
                except:
                ...
                mycursor.execute(f"update issuedbook set user_returns_on='{iss}' where b_rfid='{b}' and ub_rfid='{a}'")
                mydb.commit()
                ...
                if copies[0]<5:
                    ...
                    print("copies exceeded max limit")
